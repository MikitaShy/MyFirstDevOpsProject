...
vagrant ssh Ubuntu -- -t 'mkdir ~/ansible/; cd ~/ansible/; git init; git clone https://github.com/MikitaShy/MyVagrant-Ansible.git; cd MyVagrant-Ansible/; sudo ansible-playbook jenkins.yml; sudo ansible-playbook playbook_centos_install_docker.yml'
sleep 3
